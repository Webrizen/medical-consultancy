...
const Colleges: React.FC = () => {
  ...
  return (
    <>
      {/* MBBS Colleges Section */}
      <section id="mbbs-colleges" className="py-20 bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {mbbsColleges.map((college, index) => (
              <div 
                key={index}
      ...
      {/* BDS Colleges Section */}
      <section id="bds-colleges" className="py-20 bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {/* Header Section */}
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-blue-900">
            ...
            <p className="text-xl text-blue-800/90 max-w-3xl mx-auto font-light leading-relaxed">
              Explore premier dental colleges in India offering exceptional BDS programs. These institutions are known for their state-of-the-art facilities, experienced faculty, and comprehensive dental education.
            </p>
          </div>
